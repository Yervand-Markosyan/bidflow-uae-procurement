...
export const InfoPage: React.FC<InfoPageProps> = ({ lang }) => {
  const translations = {
    en: {
      ...
      buyerDesc: "Contractors and procurement managers can source steel, cement, electrical, and MEP materials with absolute price clarity. Post a tender, compare real-time bids, and save on project costs.",
      ...
      a1: "Bidflow is a digital platform designed for the Dubai construction market that automates the material tendering process. It connects contractors (buyers) with building material suppliers through a competitive, transparent bidding ecosystem.",
